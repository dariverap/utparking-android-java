...
public class RegistroTarifa {
    ...
    public RegistroTarifa(int id, String fecha_ingreso, String fecha_salida, int id_espacio, String patente_vehiculo, int id_usuario, int id_tarifa, double costo_total, double costo_hora) {
        this.id = id;
